...
If you're not a developer and you've stumbled upon this repository, you can access the web interface on the [TuuperCove website](https://hotcup.app).
...
- [npm](https://npmjs.com/)
- [Astro CLI](https://docs.astro.build/en/install/cli/) (Optional)
...
Need view backend source?
[click here to view](https://github.com/tuupercove/new-tpl)

## Ref.
Thank you [VtuberThaiInfo](https://vtuberthaiinfo.com) for allow (or not) to copied.
